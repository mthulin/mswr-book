...
Finally, there are countless packages and statistical methods that deserve a mention but aren't included in the book. Like any author, I've had to draw the line somewhere. If you feel that something is missing, feel free to post an issue on the book's GitHub page (https://github.com/mthulin/mswr-book), and I'll gladly consider it for future revisions.
